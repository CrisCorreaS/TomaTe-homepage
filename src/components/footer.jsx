...
function Footer() {
  return (
    <>
      <footer class="px-4 py-12 mx-auto max-w-7xl bg-bg-dark text-bg-light font-baskerville">
        <main class="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
